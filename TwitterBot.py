...
class Bot:
    ...
    def run(self):
        ...
        while True:
            ...
            time.sleep(900) #Every 10 minutes
...
def main():
    ...
    #access_key = None
    #access_secret = None
    documents = ["/home/jack/Desktop/SuperTwitterBot/corpus_1.txt", \
                 "/home/jack/Desktop/SuperTwitterBot/corpus_2.txt", \
                 "/home/jack/Desktop/SuperTwitterBot/corpus_3.txt"]
